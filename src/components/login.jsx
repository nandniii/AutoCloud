            ...
            <div className="mt-8 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <GoogleLogin
                  ...
                  text="signin_with"
                  width="240"
                  useOneTap={false} // disables auto one-tap login
                  auto_select={false} // ensures Google doesn’t auto-pick last account
                  ux_mode="popup" // opens popup instead of redirect
                  context="signin"
                  prompt="select_account"  // shows “Sign in with Google”
                />
