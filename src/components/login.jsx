            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="pl-11 mt-1 w-full p-3 bg-white/10 border border-white/20 text-white placeholder-gray-400 rounded-md focus:bg-white/20 focus:border-white/40 transition-all"
                />
              </div>
            </div>
